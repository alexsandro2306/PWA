...
const sendNotification = (userId, notification) => {
    ...
    console.log(`🔔 Enviando notificação para userId ${userId}:`, notification);

    // Emitir para a room específica
    io.to(userId.toString()).emit('notification', {
        ...notification,
        timestamp: notification.timestamp || new Date()
    });

    // TESTE: Emitir broadcast para TODOS (temporário para debug)
    ...
    console.log(`✅ Notificação emitida para ${userId}`);
};
